/*
 * RCRTC - v5.5.6-alpha.1
 * CommitId - 11eee6524aeecbb8296270deb7d66ff6561d40bc
 * Tue Oct 18 2022 15:07:14 GMT+0800 (China Standard Time)
...
(function (global, factory) {
    ...
    class RC3AnoiseTrack {
        ...
        static transformStreamTrack(audioStream) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                AAAnoiseWorklet = yield audioCxt.audioWorklet.addModule(RC3AnoiseTrack.workletModule).then(() => {
    ...
    */
     ...
     * @param runtime
     */
    const getDetectorUrls = (runtime, naviInfo) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (detectionServer && jwt) {
            const resStr = yield runtime.httpReq({
            ...
            if (detectoraddrs && engine.isArray(detectoraddrs)) {
                fastMediaUrl = yield getFastMediaUrl(detectoraddrs, runtime, jwt);
            }
        }
    ...
    class RCMediaService {
        ...
        _getDetectorUrls(naviInfo) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { fastMediaUrl, clientDetectMinute, status } = yield getDetectorUrls(this._runtime, naviInfo);
    ...
    class PolarisReporter {
         ...
         */
        sendR1() {
            const rtcVersion = "5.5.6-alpha.1";
    ...
    class JoinRoomCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, data } = yield context.joinRTCRoom(this.roomId, this.roomType, this.livingType, this.joinType, this.innerUserDatas, this.outerUserDatas);
    ...
    class ExchangeCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            var _a, _b;
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield store.service.exchange(this.headers, this.reqBody);
                ...
                if ((uris === null || uris === void 0 ? void 0 : uris.broadcast) === RCInnerCDNBroadcast.SPREAD) {
                    ...
                    const CDNUris = Object.assign({}, uris, { enableInnerCDN: true });
    ...
    class UpdateSubscribeListCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const reqBody = yield createExchangeParams(attrs, false, pc, store);
                /**
                  * 直播房间需携带 pushOtherRooms 信息
                  */
                pushOtherRooms && (reqBody.pushOtherRooms = pushOtherRooms);
                const result = yield new ExchangeCommand(headers, reqBody).execute(store, invoker);
        ...
        execute(store, invoker) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (unpublishedList.length > 0) {
                    ...
                    yield new OnRemoteUserUnpubCommand(this.subhook, tracks, this.callback.onTrackUnublish).execute(store, invoker);
                }
    ...
    class PublishCommand extends BaseCommand {
        ...
        __publish(store, peerCItem, tracks, pushOtherRooms, invoker) {
            return __awaiter(this, void 0, void 0, function* () {
         ...
         */
        _mergePublishRes(pubResList, store) {
            return __awaiter(this, void 0, void 0, function* () {
        ...
        execute(store, invoker) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const pubResList = yield Promise.all(pubTasks);
                const result = yield this._mergePublishRes(pubResList, store);
    ...
    class UnpublishCommand extends BaseCommand {
        ...
        _mergeUnpublishRes(store, unpubResList) {
            return __awaiter(this, void 0, void 0, function* () {
                 ...
                 */
                successResList.forEach((item) => __awaiter(this, void 0, void 0, function* () {
    ...
    class RetryExchangeCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const reqBody = yield createExchangeParams(subscribeList, true, pc, store);
                /**
                 * 直播房间需携带 pushOtherRooms 信息
                 */
                // const pushOtherRooms = this._getPushOtherRoomsParams()
    ...
    class RCAbstractRoom extends engine.EventEmitter {
        ...
        setRoomAttribute(key, value, message, isInner = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const code = yield this._context.setRTCData(this._roomId, key, value, isInner, RTCApiType.ROOM, message);
                if (code !== engine.ErrorCode.SUCCESS) {
        ...
        deleteRoomAttributes(keys, message, isInner = false) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const code = yield this._context.removeRTCData(this._roomId, keys, isInner, RTCApiType.ROOM, message);
                if (code !== engine.ErrorCode.SUCCESS) {
        ...
        getRoomAttributes(keys = [], isInner = false) {
            return __awaiter(this, void 0, void 0, function* () {
                const { code, data } = yield this._context.getRTCData(this._roomId, keys, isInner, RTCApiType.ROOM);
                if (code !== engine.ErrorCode.SUCCESS) {
        ...
        _leaveHandle(quitRoom) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                // 退出主房间时，退出所有 PK 房间
                this._store.isMainRoom && (yield this._quitAllPKRoom());
                // 停止 rtcPing 计时
                this._pinger.stop();
    ...
    class MCUConfigFlushCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, res } = yield store.service.setMcuConfig(headers, this.data);
                if (code !== exports.RCRTCCode.SUCCESS) {
       ...
       */
        ...
        flush(reset = true) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this._invoker.push(new MCUConfigFlushCommand(config, this._values));
                if (reset)
                    this._values = createMCUConfig();
    ...
    class EnableInnerCDNCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield new MCUConfigFlushCommand(params, this.cdnValues).execute(store, invoker);
                 ...
                 * 扩散 cdn_uris
                 */
                const { code: sendSingalCode } = yield sendCDNInfoSignal(store);
    ...
    class RTCIdentityChangeCommand extends BaseCommand {
        ...
        execute(store, invoker) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                const { code, data } = yield store.context.rtcIdentityChange(store.roomId, RTCIdentityChangeType.ViewerToAnchor, this.livingType);
                if (code !== engine.ErrorCode.SUCCESS || !data) {
                    return { code };
                }
                store.initWithRoomData(data);
    ...
    class RCLivingRoom extends RCAbstractRoom {
        ...
        __innerInit(mode, joinType, livingType, innerUserDatas, outerUserDatas) {
            const _super = Object.create(null, {
                __innerInit: { get: () => super.__innerInit }
            });
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, data } = yield _super.__innerInit.call(this, mode, joinType, livingType, innerUserDatas, outerUserDatas);
        ...
        __innerInitByIdentityChange() {
            return __awaiter(this, void 0, void 0, function* () {
                const { code, data } = yield this._invoker.push(new RTCIdentityChangeCommand(this._livingType));
                if (code === engine.ErrorCode.SUCCESS && data) {
                    this._initAfterCatchRoomData(data);
                    this._initWithRoomData(data.offlineKickTime);
        ...
        publish(tracks) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return _super.publish.call(this, tracks);
            });
        }
        unpublish(tracks) {
            const _super = Object.create(null, {
                unpublish: { get: () => super.unpublish }
            });
            return __awaiter(this, void 0, void 0, function* () {
                if (!this._store.isMainRoom) {
                ...
                return _super.unpublish.call(this, tracks);
            });
        }
        /**
         * resourceId 有效性验证
    ...
    class RCMediaStreamCapture {
        ...
        _getMediaStream(constraints, method = 'getUserMedia') {
            return __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    const stream = yield navigator.mediaDevices[method](constraintsConfig);
        ...
        createScreenVideoTrack(tag = 'screenshare', options) {
            return __awaiter(this, void 0, void 0, function* () {
                const res = yield this._createScreenTracks(tag, false, RCLoggerTag.L_RTC_CLIENT_CREATE_SCREEN_VIDEO_TRACK_O, options);
        ...
        _createScreenTracks(tag, withAudio, loggerTag, options) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { stream, code } = yield this._getMediaStream({ video, audio: electronWindowAudioConfig || audio }, this._isElectron ? 'getUserMedia' : 'getDisplayMedia');
                if (code !== exports.RCRTCCode.SUCCESS) {
                    engine.logger.error(loggerTag, {
                        status: RCLoggerStatus.FAILED,
                        code,
    ...
    class RCRTCClient extends RCMediaStreamCapture {
         ...
         */
        joinCrossRTCRoom(roomId, joinType, outerUserDatas, useMutilPeerC, roomType = RTCMode.CROSS_MUTI) {
            return __awaiter(this, void 0, void 0, function* () {
         ...
         * @param outerUserDatas 业务层设置人员属性
         */
        joinLivingRoom(roomId, livingType, joinType, outerUserDatas, useMutilPeerC) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield room.__innerInit(RTCMode.LIVE, joinType, livingType, undefined, outerUserDatas);
                if (code !== exports.RCRTCCode.SUCCESS) {
                    this._crtRoom = null;
                    return { code: code };
                }
         ...
         */
        joinLivingRoomAsAudience(roomId, livingType, useMutilPeerC) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, data } = yield this._context.joinLivingRoomAsAudience(roomId, RTCMode.LIVE, livingType);
                if (code !== engine.ErrorCode.SUCCESS) {
        ...
        upgradeToAnchorRoom(room) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const code = yield crtRoom.__innerInitByIdentityChange();
                if (code !== engine.ErrorCode.SUCCESS) {
...
`;
    ...
    class RTCContext {
        ...
        quitRTCRoom(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcRExit, true, sourceData);
                return code;
            });
        }
        getRTCRoomInfo(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcRInfo, true, sourceData);
                let data;
                if (code === engine.ErrorCode.SUCCESS && buffer) {
        ...
        getRTCUserInfoList(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                // TODO: 确认使用场景
                const sourceData = this.codec.encode(RTCPB.RtcQueryListInput, { order: 2 });
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcUData, true, sourceData);
                let data;
                if (code === engine.ErrorCode.SUCCESS && buffer) {
        ...
        removeRTCUserInfo(roomId, keys) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcUDel, false, sourceData);
                return code;
            });
        }
        setRTCData(roomId, key, value, isInner, apiType, message) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcSetData, false, sourceData);
                return code;
            });
        }
        /**
        ...
        getRTCData(roomId, keys, isInner, apiType) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcQryData, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        removeRTCData(roomId, keys, isInner, apiType, message) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcDelData, false, sourceData);
                return code;
            });
        }
        ...
        getRTCToken(roomId, mode, broadcastType) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcToken, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        setRTCState(roomId, report) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcUserState, true, sourceData);
                return code;
            });
        }
        getRTCUserList(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                const sourceData = this.codec.encode(RTCPB.RtcQueryListInput, { order: 2 });
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcUList, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        joinLivingRoomAsAudience(roomId, mode, broadcastType) {
            return __awaiter(this, void 0, void 0, function* () {
                const sourceData = encodeRtcInput(this.codec, mode, broadcastType);
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.viewerJoinR, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        quitLivingRoomAsAudience(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                const sourceData = this.codec.encode(RTCPB.SetUserStatusInput, { status: 0 });
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.viewerExitR, true, sourceData);
                return code;
            });
        }
        rtcIdentityChange(roomId, changeType, broadcastType) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcIdentityChange, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        requestRoomPK(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcInvite, true, sourceData);
                return code;
            });
        }
        cancelRoomPK(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcCancelInvite, true, sourceData);
                return code;
            });
        }
        responseRoomPK(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcInviteAnswer, true, sourceData);
                return code;
            });
        }
        endRoomPK(options) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code } = yield this.context.rtcSignaling(roomId, RTC_API.rtcEndInvite, true, sourceData);
                return code;
            });
        }
        getRTCJoinedUserInfo(userId) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const { code, buffer } = yield this.context.rtcSignaling('', RTC_API.rtcQueryJoined, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS || !buffer) {
                    return { code };
                }
        ...
        pullRTCRoomEntry(roomId) {
            return __awaiter(this, void 0, void 0, function* () {
                // 不适用增量拉取，直接全量拉取 KV，timestamp 为 0
                const sourceData = this.codec.encode(RTCPB.RtcPullKV, { timestamp: 0, roomId });
                const { code, buffer } = yield this.context.rtcSignaling(roomId, RTC_API.rtcPullKv, true, sourceData);
                if (code !== engine.ErrorCode.SUCCESS) {
                    return { code };
                }
    ...
    const installer = {
        ...
        verify(runtime) {
            ...
            engine.VersionManage.add('plugin-rtc', "5.5.6-alpha.1");
            if (!engine.VersionManage.validEngine("^5.5.1")) {
                logger.error(`The current engine version '${engine.VersionManage.getInfo().engine}' error, plugin-rtc required engine version at least '${"^5.5.1"}'.`);
                return false;
            }
            return true;
        },
        setup(context, runtime, options = {}) {
            ...
            logger.warn(`RCRTC Version: ${"5.5.6-alpha.1"}, Commit: ${"11eee6524aeecbb8296270deb7d66ff6561d40bc"}`);
