 ...
 */
import { Logger, EventEmitter, logger as logger$1, LogSource, isNumber, validate, isObject as isObject$1, ErrorCode, HttpMethod, isArray, PING_REQ_TIMEOUT, ConnectionStatus, notEmptyObject, notEmptyArray, notEmptyString, isString, assert, ConversationType, isHttpUrl, isBoolean, isUndefined, forEach, VersionManage } from '@rongcloud/engine';

const logger = new Logger('RCRTC');
...
class RCTrack extends EventEmitter {
    ...
    mute() {
        ...
        logger$1.info(RCLoggerTag.L_TRACK_MUTE_O, {
    ...
    unmute() {
        ...
        logger$1.info(RCLoggerTag.L_TRACK_UNMUTE_O, {
            status: RCLoggerStatus.SUCCESSED,
            id: this._id
        }, {
            logSource: LogSource.RTC
    ...
    async play(element, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.volume) {
            ...
            if ((options === null || options === void 0 ? void 0 : options.volume) < 0) {
                ...
                logger$1.warn(RCLoggerTag.L_TRACK_PLAY_R, {
                    status: RCLoggerStatus.FAILED,
                    code: '',
...
class RCLocalTrack extends RCTrack {
    ...
    __innerSetPublished(bool) {
        logger$1.info(RCLoggerTag.L_LOCAL_TRACK_INNER_SET_PUBLISHED_O, {
            status: RCLoggerStatus.SUCCESSED,
            bool
        }, {
            logSource: LogSource.RTC
    ...
    destroy() {
        ...
        logger$1.info(RCLoggerTag.L_LOCAL_TRACK_DESTROY_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    setBitrate(max = 0, min = 0, start = 0) {
        if (!isNumber(max) || !isNumber(min) || !isNumber(start) || max <= 0 || min <= 0 || max < min) {
            ...
            logger$1.error(RCLoggerTag.L_LOCAL_TRACK_SET_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_LOCAL_TRACK_SET_BITRATE_O, {
            status: RCLoggerStatus.SUCCESSED,
            max,
            min,
            start
...
class RCLocalAudioTrack extends RCLocalTrack {
    ...
    setRecommendBitrate(audio) {
        if (!validate('livingType', audio, value => value in RCAudioBitrate)) {
            logger$1.warn(RCLoggerTag.L_RTC_SET_RECOMMEND_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
...
class RCLocalVideoTrack extends RCLocalTrack {
    ...
    setRecommendBitrate(video) {
        if (!validate('livingType', video, value => value in RCVideoBitrate)) {
            logger$1.warn(RCLoggerTag.L_RTC_SET_RECOMMEND_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
...
class RCLocalFileAudioTrack extends RCLocalFileTrack {
    ...
    play() {
        ...
        this._setLocalMuted(false);
        return Promise.resolve({ code: RCRTCCode.SUCCESS });
    }
    /**
     * @override __innerSetMediaStreamTrack
     * @params {track} MediaStreamTrack 添加音频流
...
class RCRemoteTrack extends RCTrack {
    ...
    __innerSetSubscribed(bool) {
        ...
        logger$1.info(RCLoggerTag.L_REMOTE_TRACK_INNER_SET_SUBSCRIBED_O, {
            status: RCLoggerStatus.SUCCESSED,
            bool
        }, {
            logSource: LogSource.RTC
...
const isValidResolution = (resolution) => {
    return !!RCResolution[resolution];
};
/**
 * 判断帧率枚举值有效性
 * @param fps
...
class Pinger {
    ...
    start() {
        ...
        logger$1.info(RCLoggerTag.L_PINGER_START_O, {
            status: RCLoggerStatus.SUCCESSED,
            interval: this._gap
        }, {
            logSource: LogSource.RTC
    ...
    async _checkAlive() {
        ...
        if (code === ErrorCode.TIMEOUT) {
            logger$1.error(RCLoggerTag.L_PINGER_TIMEOUT_O, {
    ...
    stop() {
        ...
        logger$1.info(RCLoggerTag.L_PINGER_STOP_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
...
class RCMediaService {
    ...
    detectorMediaSever() {
        ...
        logger$1.info(`set msInDetector => ${JSON.stringify(RCMediaService.msInDetector)}`);
    ...
    async _request(path, headers, body) {
        ...
        if (urls.length === 0) {
            ...
            logger$1.error(RCLoggerTag.L_MEDIA_SERVICE_REQUEST_R, {
                status: RCLoggerStatus.FAILED,
        ...
        for (let i = 0; i < urls.length; i += 1) {
            ...
            logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_REQUEST_T, {
                url,
                // headers,
                // body,
                reqId
            ...
            if (status === 200) {
                ...
                logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_REQUEST_R, {
                    status: RCLoggerStatus.SUCCESSED,
                    url,
                    reqId
                }, {
    ...
    async exchange(headers, body) {
        ...
        if (data.code === RCRTCCode.SUCCESS && ((_a = data.data) === null || _a === void 0 ? void 0 : _a.resultCode) === RCRTCCode.SUCCESS) {
    ...
    async setMcuConfig(headers, body) {
        logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_SET_MCU_CONFIG_T, {
            headers,
            body
        }, {
            logSource: LogSource.RTC
        ...
        if (!this._configUrl) {
            ...
            logger$1.error(RCLoggerTag.L_MEDIA_SERVICE_SET_MCU_CONFIG_R, {
                status: RCLoggerStatus.FAILED,
        ...
        if (status === 200) {
            ...
            logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_SET_MCU_CONFIG_R, {
                status: RCLoggerStatus.SUCCESSED,
                reqId
            }, {
                logSource: LogSource.RTC
    ...
    async getCDNResourceInfo(headers, url) {
        logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_GET_CDN_RESOURCE_INFO_T, {
            headers,
            url
        }, {
            logSource: LogSource.RTC
        ...
        if (status === 200) {
            ...
            logger$1.info(RCLoggerTag.L_MEDIA_SERVICE_GET_CDN_RESOURCE_INFO_R, {
                status: RCLoggerStatus.SUCCESSED,
...
class AbstractStatParser {
    ...
    formatRCRTCStateReport(stats) {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_STAT_PARSER_FORMAT_RTC_STATE_REPORT_O, {
            status: RCLoggerStatus.SUCCESSED,
            stats,
            reports
        }, {
...
class ASdpStrategy {
    ...
    static setSdpSemantics(sdpSemantics) {
        logger$1.info(RCLoggerTag.L_A_SDP_STRATEGY_SET_SDP_SEMANTICS_O, {
            status: RCLoggerStatus.SUCCESSED,
            sdpSemantics
        }, {
            logSource: LogSource.RTC
        ...
        logger$1.debug(`sdpSemantics, browser: ${browser}, version: ${version}, supportsUnifiedPlan: ${supportsUnifiedPlan}`);
    ...
    async setRemoteAnswer(sdp) {
        ...
        try {
            ...
            logger.error(error);
            logger$1.info(RCLoggerTag.L_A_SDP_STRATEGY_SET_REMOTE_ANSWER_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: error
            }, {
 ...
 * PC 实例管理类
 */
class RCRTCPeerConnection extends EventEmitter {
    constructor(
    /**
     * peerConnection 对应名称
    */
    ...
    getLocalTracks() {
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_GET_LOCAL_TRACKS_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    _onConnectionStateChange() {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_CONNECTION_STATE_S, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    _onICEConnectionStateChange() {
        ...
        if (this._rtcPeerConn.iceConnectionState === 'failed' || this._rtcPeerConn.iceConnectionState === 'disconnected') {
            ...
            logger$1.error(RCLoggerTag.L_RTC_PEER_CONNECTION_ICE_CONNECTION_STATE_S, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_ICE_CONNECTION_STATE_S, {
            status: RCLoggerStatus.SUCCESSED,
            connectionState: this._rtcPeerConn.connectionState,
            pcName: this._pcName
        }, {
    ...
    async setBitrate(max, min, start) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_SET_BITRATE_O, {
            status: RCLoggerStatus.SUCCESSED,
            max,
            min,
            start
    ...
    async createOffer(iceRestart) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_CREATE_OFFER_O, {
            status: RCLoggerStatus.SUCCESSED,
            offerSDP: offer.sdp
        }, {
            logSource: LogSource.RTC
    ...
    async setRemoteAnswer(answer) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_SET_REMOTE_ANSWER_O, {
            status: RCLoggerStatus.SUCCESSED,
            answer
        }, {
            logSource: LogSource.RTC
    ...
    addLocalTrack(track) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_ADD_LOCAL_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    removeLocalTrackById(trackId) {
        ...
        if (!track) {
            logger$1.warn(RCLoggerTag.L_RTC_PEER_CONNECTION_REMOVE_LOCAL_TRACK_BY_ID_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: 'track not found'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_REMOVE_LOCAL_TRACK_BY_ID_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId
        }, {
            logSource: LogSource.RTC
    ...
    removeAllLocalTrack() {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_REMOVE_ALL_LOCAL_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    removeLocalTrack(track) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_REMOVE_LOCAL_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId
        }, {
            logSource: LogSource.RTC
    ...
    updateSubRemoteTracks(remoteTracks) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_UPDATE_SUB_REMOTE_TRACKS_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    destroy() {
        ...
        logger$1.info(RCLoggerTag.L_RTC_PEER_CONNECTION_DESTROY_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    _initRemoteTracks() {
        for (const userId in this._roomResources) {
            ...
            resArr.forEach(item => {
                ...
                const remoteTrack = mediaType === RCMediaType.AUDIO_ONLY ? new RCRemoteAudioTrack(tag, userId) : new RCRemoteVideoTrack(tag, userId);
...
class JoinRoomCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        if (!validate('roomType', this.roomType, (value) => RTCMode[value] !== undefined)) {
            logger$1.error(logTag, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        if (!validate('outerUserDatas', this.outerUserDatas, isObject$1, false)) {
            logger$1.error(logTag, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        if (this.outerUserDatas) {
            const valid = Object.keys(this.outerUserDatas).every(key => {
                return validate(`outerUserDatas.${key}`, this.outerUserDatas[key], isString, true);
            });
            if (!valid) {
                logger$1.error(logTag, {
                    status: RCLoggerStatus.FAILED,
        ...
        logger.info(`joinRoom -> roomId: ${this.roomId}; joinType: ${this.joinType || RTCJoinType.KICK}`);
        ...
        if (code !== ErrorCode.SUCCESS || !data) {
            ...
            const errorCode = code === 40032 ? RCRTCCode.SIGNAL_JOIN_RTC_ROOM_REFUSED : code;
            logger$1.error(logTag, {
                status: RCLoggerStatus.FAILED,
                code: errorCode,
...
async function sendCDNInfoSignal(store) {
    ...
    logger$1.info(RCLoggerTag.L_LIVING_ROOM_SPREAD_CDN_INFO_T, {
        roomId,
        CDNUris
    }, {
        logSource: LogSource.RTC
    ...
    if (isSuccess) {
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_SPREAD_CDN_INFO_R, {
            status: RCLoggerStatus.SUCCESSED,
            CDNUris
        }, {
            logSource: LogSource.RTC
        ...
        logger$1.error(RCLoggerTag.L_LIVING_ROOM_SPREAD_CDN_INFO_R, {
            status: RCLoggerStatus.FAILED,
...
class UpdateSubscribeListCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        const roomId = store.roomId;
        if (!validate('tracks', tracks, () => {
            return isArray(tracks) && tracks.every(res => {
...
class UnsubscribeCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        const roomId = store.roomId;
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_UNSUBSCRIBE_T, {
            trackIds: tracks.map(getTrackIdFromAttr)
        }, {
            logSource: LogSource.RTC
        });
        if (!validate('tracks', tracks, () => {
            return isArray(tracks) && tracks.length > 0 && tracks.every(item => item instanceof RCRemoteTrack);
        }, true)) {
            logger.warn(`unsubscribe failed, tracks is invalid -> roomId: ${roomId}`);
            logger$1.warn(RCLoggerTag.L_ABSTRACT_ROOM_UNSUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_UNSUBSCRIBE_R, {
            trackIds: tracks.map(getTrackIdFromAttr),
            roomId
        }, {
            logSource: LogSource.RTC
        ...
        if (publishedList.length > 0) {
            ...
            publishedList.forEach(item => {
                ...
                if (rTrack) {
                    ...
                    rTrack = mediaType === RCMediaType.AUDIO_ONLY ? new RCRemoteAudioTrack(tag, userId) : new RCRemoteVideoTrack(tag, userId);
...
class SubscribeCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        const { tracks, forceReq } = this;
        const roomId = store.roomId;
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SUBSCRIBE_T, {
            trackIds: tracks.map(getTrackIdFromAttr),
            forceReq
        }, {
            logSource: LogSource.RTC
        ...
        if (!validate('tracks', tracks, () => {
            return isArray(tracks) && tracks.length > 0 && tracks.every(item => {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_SUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> tracks'
            }, {
        ...
        if (!changed && !forceReq) {
            logger$1.warn(RCLoggerTag.L_ABSTRACT_ROOM_SUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SUBSCRIBE_R, {
            trackIds: tracks.map(getTrackIdFromAttr),
            roomId
        }, {
            logSource: LogSource.RTC
...
class PublishCommand extends BaseCommand {
            ...
            if (localTrack.isVideoTrack()) {
                if (pubTiny) {
                    ...
                    try {
                        ...
                        const rcFrameRate = pubTiny.frameRate || RCFrameRate.FPS_15;
    ...
    async execute(store, invoker) {
         ...
         */
        if (!validate('tracks', tracks, () => {
            return isArray(tracks) && tracks.length > 0 && tracks.every(item => item instanceof RCLocalTrack || item.track instanceof RCLocalTrack);
        }, true)) {
            logger.warn(`publish failed, tracks is invalid -> roomId: ${roomId}`);
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_PUBLISH_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> tracks'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_PUBLISH_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId,
            trackIds: tracks.map(getTrackIdFromAttr)
        }, {
...
class UnpublishCommand extends BaseCommand {
    ...
    async _mergeUnpublishRes(store, unpubResList) {
        ...
        const res = { code: RCRTCCode.SUCCESS };
    ...
    async execute(store, invoker) {
        ...
        const tracks = this.tracks;
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_UNPUBLISH_T, {
            trackIds: tracks.map(getTrackIdFromAttr)
        }, {
            logSource: LogSource.RTC
        });
        // 参数有效性验证
        const valid = validate('tracks', tracks, () => {
        ...
        if (!valid) {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_UNPUBLISH_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> tracks'
            }, {
...
class OnSignalReconnectedCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_RECONNECTED_T, {
            livingType
        }, {
            logSource: LogSource.RTC
        });
        ...
        if (somePeerClosed) {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_RECONNECTED_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_RECONNECTED_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomData: data
        }, {
            logSource: LogSource.RTC
    ...
    executeInLivingRoom(store, data) {
        var _a, _b;
        logger$1.error(RCLoggerTag.L_LIVING_ROOM_RECONNECTED_T, {
            roomData: data
        }, {
            logSource: LogSource.RTC
        });
        if (!data) {
            logger$1.info(RCLoggerTag.L_LIVING_ROOM_RECONNECTED_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: 'room not fond'
            }, {
        ...
        if (!CDNUris) {
            logger$1.error(RCLoggerTag.L_LIVING_ROOM_RECONNECTED_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
...
class AsyncUpdateSubscribeListCommand extends AsyncCommand {
    ...
    async execute(store, invoker) {
        ...
        return new Promise(resolve => {
            ...
            resolve({ code: RCRTCCode.SUCCESS });
        });
    }
}
...
class RCAbstractRoom extends EventEmitter {
    ...
    setBitrate(max, min, start) {
        ...
        assert('max', max, (value) => {
            return isNumber(value) && value > Math.max(min || 1, 200);
        }, true);
        assert('min', min, (value) => {
            return isNumber(value) && value >= 1 && (isNumber(max) ? value < max : true);
        }, true);
    ...
    _callAppListener(eventType, ...attrs) {
        var _a;
        eventType !== 'onPing' && logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_CALL_APP_LISTENER_O, {
            status: RCLoggerStatus.SUCCESSED,
            eventType,
            attrs
        }, {
    ...
    async sendMessage(name, content) {
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SEND_MESSAGE_T, {
            name,
            content
        }, {
            logSource: LogSource.RTC
        ...
        if (code !== ErrorCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_SEND_MESSAGE_R, {
                status: RCLoggerStatus.FAILED,
                code,
                msg: ''
            }, {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SEND_MESSAGE_R, {
            status: RCLoggerStatus.SUCCESSED,
            name,
            content
        }, {
    ...
    async setRoomAttribute(key, value, message, isInner = false) {
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SET_ROOM_ATTRIBUTE_T, {
            roomId: this._roomId,
            key,
            value,
            message,
        ...
        if (code !== ErrorCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_SET_ROOM_ATTRIBUTE_R, {
                status: RCLoggerStatus.FAILED,
                code,
                msg: ''
            }, {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_SET_ROOM_ATTRIBUTE_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId: this._roomId,
            key,
            value,
    ...
    async deleteRoomAttributes(keys, message, isInner = false) {
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_DELETE_ROOM_ATTRIBUTE_T, {
            roomId: this._roomId,
            keys,
            message,
            isInner
        ...
        if (code !== ErrorCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_ABSTRACT_ROOM_DELETE_ROOM_ATTRIBUTE_R, {
                status: RCLoggerStatus.FAILED,
                code,
                msg: ''
            }, {
        ...
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_DELETE_ROOM_ATTRIBUTE_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId: this._roomId,
            keys,
            message,
    ...
    registerRoomEventListener(listener) {
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_REGISTER_ROOM_EVENT_LISTENER_O, {
            status: RCLoggerStatus.SUCCESSED,
     ...
     */
    registerReportListener(listener) {
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_REGISTER_REPORT_LISTENER_O, {
            status: RCLoggerStatus.SUCCESSED,
            listener: listener && Object.keys(listener)
        }, {
            logSource: LogSource.RTC
    ...
    onAudioLevelChange(handler, gap) {
        var _a;
        logger$1.info(RCLoggerTag.L_ABSTRACT_ROOM_AUDIO_LEVEL_O, {
            status: RCLoggerStatus.SUCCESSED,
...
class MCUConfigFlushCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        ...
        if (code === RCRTCCode.SUCCESS && (((_b = (_a = values.output) === null || _a === void 0 ? void 0 : _a.video.normal) === null || _b === void 0 ? void 0 : _b.width) || ((_d = (_c = values.output) === null || _c === void 0 ? void 0 : _c.video.normal) === null || _d === void 0 ? void 0 : _d.fps))) {
            sendCDNInfoSignal(store);
        }
        return { code, res };
    }
...
})(BackgroundPictureFillMode || (BackgroundPictureFillMode = {}));
...
})(MixVideoRenderMode || (MixVideoRenderMode = {}));
...
class RCMCUConfigBuilder {
    ...
    setHostVideoTrack(videoTrackId) {
        ...
        if (!this._isValidTrackId(videoTrackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_HOST_VIDEO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_HOST_VIDEO_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
            videoTrackId
        }, {
            logSource: LogSource.RTC
    ...
    setMixLayoutMode(mode) {
        ...
        if (!valid) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_MIX_LAYOUT_MODE_O, {
                status: RCLoggerStatus.SUCCESSED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_MIX_LAYOUT_MODE_O, {
            status: RCLoggerStatus.SUCCESSED,
            mode
        }, {
            logSource: LogSource.RTC
    ...
    setOutputVideoResolution(resolution) {
        ...
        if (!isValidResolution(resolution)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_RESOLUTION_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_RESOLUTION_O, {
            status: RCLoggerStatus.SUCCESSED,
            resolution
        }, {
            logSource: LogSource.RTC
    ...
    setOutputVideoFPS(fps) {
        ...
        if (!isValidFPS(fps)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_FPS_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_FPS_O, {
            status: RCLoggerStatus.SUCCESSED,
            fps
        }, {
            logSource: LogSource.RTC
    ...
    setOutputVideoBitrate(bitrate) {
        ...
        if (!isNumber(bitrate) || bitrate <= 0) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_BITRATE_O, {
            status: RCLoggerStatus.SUCCESSED,
            bitrate
        }, {
            logSource: LogSource.RTC
    ...
    setOutputTinyVideoResolution(resolution) {
        ...
        if (!isValidResolution(resolution)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_RESOLUTION_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> resolution: ${resolution}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_RESOLUTION_O, {
            status: RCLoggerStatus.SUCCESSED,
            resolution
        }, {
            logSource: LogSource.RTC
    ...
    setOutputTinyVideoFPS(fps) {
        ...
        if (!isValidFPS(fps)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_FPS_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> fps: ${fps}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_FPS_O, {
            status: RCLoggerStatus.SUCCESSED,
            fps
        }, {
            logSource: LogSource.RTC
    ...
    setOutputTinyVideoBitrate(bitrate) {
        ...
        if (!isNumber(bitrate) || bitrate <= 0) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> bitrate: ${bitrate}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_TINY_VIDEO_BITRATE_O, {
            status: RCLoggerStatus.SUCCESSED,
            bitrate
        }, {
            logSource: LogSource.RTC
    ...
    setOutputVideoRenderMode(renderMode) {
        ...
        if (![MixVideoRenderMode.CROP, MixVideoRenderMode.WHOLE].includes(renderMode)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_RENDER_MODE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_VIDEO_RENDER_MODE_O, {
            status: RCLoggerStatus.SUCCESSED,
            renderMode
        }, {
            logSource: LogSource.RTC
    ...
    setOutputAudioBitrate(bitrate) {
        ...
        if (isNumber(bitrate) && bitrate > 0) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_AUDIO_BITRATE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> bitrate: ${bitrate}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_AUDIO_BITRATE_O, {
            status: RCLoggerStatus.SUCCESSED,
            bitrate
        }, {
            logSource: LogSource.RTC
    ...
    setOutputBackgroundColor(color) {
        ...
        if (!/^0x[a-fA-F0-9]{6}$/.test(color)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_COLOR_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_COLOR_O, {
            status: RCLoggerStatus.SUCCESSED,
            color
        }, {
            logSource: LogSource.RTC
    ...
    addOutputBackgroundPicture(uri, x, y, w, h) {
        ...
        if (!isHttpUrl(uri)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_PICTURE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_PICTURE_O, {
            status: RCLoggerStatus.SUCCESSED,
            uri,
            x,
            y,
    ...
    removeOutputBackgroundPicture(uri) {
        ...
        if (!isHttpUrl(uri)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_OUTPUT_BACKGROUND_PICTURE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> uri: ${uri}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_OUTPUT_BACKGROUND_PICTURE_O, {
            status: RCLoggerStatus.SUCCESSED,
            uri
        }, {
            logSource: LogSource.RTC
    ...
    clearOutputBackgroundPicture() {
        ...
        this._addOutputValue('video', { pictures: [] }, 'backgroundPicture');
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_CLEAR_OUTPUT_BACKGROUND_PICTURE_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    setOutputBackgroundPictureFillMode(fillMode) {
        ...
        if (![BackgroundPictureFillMode.CROP, BackgroundPictureFillMode.WHOLE].includes(fillMode)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_PICTURE_FILL_MODE_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_OUTPUT_BACKGROUND_PICTURE_FILL_MODE_O, {
            status: RCLoggerStatus.SUCCESSED,
            fillMode
        }, {
            logSource: LogSource.RTC
    ...
    addPublishStreamUrls(urls) {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_PUBLISH_STREAM_URLS_O, {
            status: RCLoggerStatus.SUCCESSED,
            urls
        }, {
            logSource: LogSource.RTC
    ...
    removePublishStreamUrls(urls) {
        ...
        if (invalid) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_PUBLISH_STREAM_URLS_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> urls: ${urls.join(',')}`
            }, {
        ...
        this._addOutputValue('cdn', cdns);
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_PUBLISH_STREAM_URLS_O, {
            status: RCLoggerStatus.SUCCESSED,
            urls
        }, {
            logSource: LogSource.RTC
    ...
    clearPublishStreamUrls() {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_CLEAR_PUBLISH_STREAM_URLS_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    addCustomizeLayoutVideo(trackId, x, y, width, height) {
        ...
        if (!notEmptyString(trackId) || !this._isValidTrackId(trackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_LAYOUT_VIDEO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        if (video.some(item => item.height === height && item.width === width &&
            ...
            item.x === x && item.y === y)) {
            logger$1.warn(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_LAYOUT_VIDEO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_LAYOUT_VIDEO_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId,
            x,
            y,
    ...
    removeCustomizeLayoutVideo(trackId) {
        ...
        if (!this._isValidTrackId(trackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_CUSTOMIZE_LAYOUT_VIDEO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> trackId: ${trackId}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_CUSTOMIZE_LAYOUT_VIDEO_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId
        }, {
            logSource: LogSource.RTC
    ...
    clearCustomizeLayoutVideo() {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_CLEAR_CUSTOMIZE_LAYOUT_VIDEO_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    setCustomizeInputAudio(trackIds) {
        ...
        if (trackIds.some(id => this._isValidTrackId(id))) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_CUSTOMIZE_INPUT_AUDIO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_SET_CUSTOMIZE_INPUT_AUDIO_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackIds
        }, {
            logSource: LogSource.RTC
    ...
    addCustomizeInputAudio(trackId) {
        ...
        if (!this._isValidTrackId(trackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_INPUT_AUDIO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> trackId: ${trackId}`
            }, {
        ...
        if (audio.some(item => item.stream_id === streamId && item.user_id === userId)) {
            logger$1.warn(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_INPUT_AUDIO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        this._values.inputFilterMode = RCMixInputFilterMode.AUDIO_INPUT_VIDEO_ALL;
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_CUSTOMIZE_INPUT_AUDIO_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId
        }, {
            logSource: LogSource.RTC
    ...
    removeCustomizeInputAudio(trackId) {
        ...
        if (!this._isValidTrackId(trackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_CUSTOMIZE_INPUT_AUDIO_O, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: `params error -> trackId: ${trackId}`
            }, {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_CUSTOMIZE_INPUT_AUDIO_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId
        }, {
            logSource: LogSource.RTC
    ...
    clearCustomizeInputAudio() {
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_CLEAR_CUSTOMIZE_INPUT_AUDIO_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    addPictureWaterMark(trackId, uri, x, y, w, h) {
        ...
        if (!this._isValidTrackId(trackId)) {
            ...
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_ADD_SINGLE_WATER_MARK_O, {
   ...
   */
    removePictureWaterMark(trackId, uri) {
        if (!notEmptyString(trackId) || !this._isValidTrackId(trackId)) {
            logger$1.error(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_SINGLE_WATER_MARK_O, {
                status: RCLoggerStatus.FAILED, code: '', msg: `params error -> trackId: ${trackId}`
            }, {
                logSource: LogSource.RTC
            });
        ...
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_REMOVE_SINGLE_WATER_MARK_O, { status: RCLoggerStatus.SUCCESSED, trackId, uri }, {
            logSource: LogSource.RTC
        });
        return this;
    }
    ...
    reset() {
        ...
        this._values = createMCUConfig();
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_RESET_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    async flush(reset = true) {
        ...
        if (reset)
            this._values = createMCUConfig();
        logger$1.info(RCLoggerTag.L_MCU_CONFIG_BUILDER_FLUSH_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
...
class ExchangeWithPushOtherRoomCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        const { roomId } = this;
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_JOINED_PK_ROOM_T, {
            roomId,
            userId: store.crtUserId
        }, {
            logSource: LogSource.RTC
        ...
        if (!this.roomPKHandler) {
            logger$1.error(RCLoggerTag.L_LIVING_ROOM_JOINED_PK_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
...
class LeaveOtherRoomCommand extends BaseCommand {
   ...
   */
    ...
    async execute(store, invoker) {
        ...
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_LEAVE_PK_ROOM_T, {
            roomId,
            userId: store.crtUserId,
            isQuitPK
        }, {
        ...
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_LEAVE_PK_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId,
            userId: store.crtUserId,
            isQuitPK
...
class RCLivingPKHandler {
    ...
    registerRoomPKEventListener(listener) {
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_REGISTER_ROOM_PK_EVENT_LISTENER_O, {
            status: RCLoggerStatus.SUCCESSED,
            listener: listener && Object.keys(listener)
        }, {
            logSource: LogSource.RTC
    ...
    async requestJoinOtherRoom(inviteeRoomId, inviteeUserId, options) {
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_REQUEST_JOIN_OTHER_ROOM_T, {
            inviteeRoomId,
            inviteeUserId,
            options
        }, {
        ...
        if (!(validate('inviteeRoomId', inviteeRoomId, notEmptyString, true) &&
            ...
            logger$1.error(RCLoggerTag.L_LIVING_PK_HANDLER_REQUEST_JOIN_OTHER_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_REQUEST_JOIN_OTHER_ROOM_R, {
            inviteeRoomId,
            inviteeUserId,
            options
        }, {
    ...
    async cancelRequestJoinOtherRoom(inviteeRoomId, inviteeUserId, extra) {
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_CANCEL_REQUEST_JOIN_OTHER_ROOM_T, {
            inviteeRoomId,
            inviteeUserId,
            extra,
            userId: this._context.getCurrentId(),
        ...
        if (!(validate('inviteeRoomId', inviteeRoomId, notEmptyString, true) &&
            validate('inviteeUserId', inviteeUserId, notEmptyString, true))) {
            logger$1.error(RCLoggerTag.L_LIVING_PK_HANDLER_CANCEL_REQUEST_JOIN_OTHER_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_CANCEL_REQUEST_JOIN_OTHER_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            inviteeRoomId,
            inviteeUserId,
            extra
    ...
    async responseJoinOtherRoom(inviterRoomId, inviterUserId, agree, options) {
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_RESPONSE_JOIN_OTHER_ROOM_T, {
            inviterRoomId,
            inviterUserId,
            agree,
            options,
        ...
        if (!(validate('inviterRoomId', inviterRoomId, notEmptyString, true) &&
            ...
            logger$1.error(RCLoggerTag.L_LIVING_PK_HANDLER_RESPONSE_JOIN_OTHER_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        !isUndefined(options === null || options === void 0 ? void 0 : options.extra) && Object.assign(content, { extra: options.extra });
        const params = {
            agree,
            roomId: this._mainRoomId,
            inviteSessionId,
        ...
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_RESPONSE_JOIN_OTHER_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            inviterRoomId,
            inviterUserId,
            agree,
    ...
    async joinOtherRoom(roomId) {
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_JOIN_OTHER_ROOM_T, {
            roomId,
            userId: this._context.getCurrentId()
        }, {
            logSource: LogSource.RTC
        ...
        if (!(validate('roomId', roomId, notEmptyString, true))) {
            logger$1.error(RCLoggerTag.L_LIVING_PK_HANDLER_JOIN_OTHER_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> roomId'
            }, {
        ...
        if (this._joinedPKRooms[roomId]) {
            logger$1.warn(RCLoggerTag.L_LIVING_PK_HANDLER_JOIN_OTHER_ROOM_R, {
                status: RCLoggerStatus.FAILED,
        ...
        logger$1.info(RCLoggerTag.L_LIVING_PK_HANDLER_JOIN_OTHER_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId,
            userId: this._context.getCurrentId()
        }, {
...
class EnableInnerCDNCommand extends BaseCommand {
    ...
    async execute(store, invoker) {
        const { enable } = this;
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_ENABLE_INNER_CDN_T, {
            roomId: store.roomId,
            enable
        }, {
            logSource: LogSource.RTC
        ...
        if (!store.isMainRoom) {
            ...
            logger$1.error(RCLoggerTag.L_LIVING_ROOM_ENABLE_INNER_CDN_R, {
                status: RCLoggerStatus.FAILED,
        ...
        if (CDNUris && (CDNUris.broadcast !== RCInnerCDNBroadcast.SPREAD)) {
            ...
            logger$1.info(RCLoggerTag.L_LIVING_ROOM_ENABLE_INNER_CDN_R, {
                status: RCLoggerStatus.SUCCESSED,
                enable
            }, {
                logSource: LogSource.RTC
...
class RCLivingRoom extends RCAbstractRoom {
    ...
    async __innerInit(mode, joinType, livingType, innerUserDatas, outerUserDatas) {
        if (!(validate('livingType', livingType, (value) => value === RCLivingType.AUDIO || value === RCLivingType.VIDEO))) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_JOIN_LIVING_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
    ...
    async __innerInitByIdentityChange() {
        ...
        if (code === ErrorCode.SUCCESS && data) {
            this._initAfterCatchRoomData(data);
            this._initWithRoomData(data.offlineKickTime);
            logger$1.info(RCLoggerTag.L_RTC_CLIENT_UPGRADE_TO_ANCHOR_ROOM_R, {
                status: RCLoggerStatus.SUCCESSED,
                roomData: data
            }, {
                logSource: LogSource.RTC
    ...
    getRoomPKHandler() {
        ...
        if (!this._store.isMainRoom) {
            ...
            logger$1.error(RCLoggerTag.L_LIVING_ROOM_GET_ROOM_PK_HANDLER_O, {
                status: RCLoggerStatus.SUCCESSED,
                code: RCRTCCode.THE_FUNCTION_IS_DISABLED_IN_PKROOM,
                msg: 'method not available in room'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_GET_ROOM_PK_HANDLER_O, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    async _quitAllPKRoom() {
        ...
        logger$1.info(RCLoggerTag.L_LIVING_ROOM_QUIT_ALL_PK_ROOM_O, {
            status: RCLoggerStatus.SUCCESSED,
...
class RCAudienceClient {
    ...
    async __subscribe(liveUrl, livingType, mediaType, subTiny = false) {
        var _a;
        logger$1.info(RCLoggerTag.L_AUDIENCE_CLIENT_SUBSCRIBE_T, {
            liveUrl,
            livingType,
            mediaType,
            subTiny
        ...
        logger$1.info(RCLoggerTag.L_AUDIENCE_CLIENT_SUBSCRIBE_R, {
            status: RCLoggerStatus.SUCCESSED,
            liveUrl
        }, {
            logSource: LogSource.RTC
    ...
    async __unsubscribe() {
        var _a;
        logger$1.info(RCLoggerTag.L_AUDIENCE_CLIENT_UNSUBSCRIBE_T, {
        ...
        if (!this._rtcToken || !this._liveUrl) {
            logger$1.warn(RCLoggerTag.L_AUDIENCE_CLIENT_UNSUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        if (code !== RCRTCCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_AUDIENCE_CLIENT_UNSUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code,
                msg: ''
            }, {
            ...
            logger$1.info(RCLoggerTag.L_AUDIENCE_CLIENT_UNSUBSCRIBE_R, {
                status: RCLoggerStatus.SUCCESSED,
                liveUrl: this._liveUrl
            }, {
                logSource: LogSource.RTC
...
class RCAudienceLivingRoom {
    ...
    singalDataChange(singalData, roomId) {
        var _a;
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SINGAL_DATA_CHANGE_T, {
            singalData,
            roomId,
            userId: this._context.getCurrentId()
        }, {
        ...
        if (roomId !== this._roomId) {
            ...
            logger$1.error(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SINGAL_DATA_CHANGE_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SINGAL_DATA_CHANGE_R, {
            status: RCLoggerStatus.SUCCESSED,
            singalData,
            roomId,
            userId: this._context.getCurrentId()
    ...
    async _diffRoomResource(uris) {
        ...
        uris.forEach(uri => {
            ...
            if (!this._remoteTracks[localTrackId]) {
                // 置为新发布的 track
                const rTrack = mediaType === RCMediaType.AUDIO_ONLY ? new RCRemoteAudioTrack(tag, '', this._roomId) : new RCRemoteVideoTrack(tag, '', this._roomId);
    ...
    */
    ...
    async _subscribeHandle(tracks, forceReq = false) {
        var _a;
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SUBSCRIBE_T, {
            trackIds: tracks.map(getTrackIdFromAttr),
            roomId: this._roomId,
            userId: this._context.getCurrentId(),
            forceReq
        ...
        const roomStatusCode = this._assertRoomDestroyed();
        if (roomStatusCode) {
            logger$1.error(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
        ...
        if (!trackChanged && !forceReq) {
            logger$1.warn(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: 'repeat subscribe'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_SUBSCRIBE_R, {
            status: RCLoggerStatus.SUCCESSED,
            trackIds: tracks.map(getTrackIdFromAttr),
            roomId: this._roomId,
            userId: this._context.getCurrentId(),
    ...
    async getCDNPlayUrl(resolution, fps) {
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_GET_CDN_PLAY_URL_T, {
            resolution,
            fps
        }, {
            logSource: LogSource.RTC
        ...
        if (resolution && !isValidResolution(resolution)) {
            ...
            logger$1.error(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_GET_CDN_PLAY_URL_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_GET_CDN_PLAY_URL_R, {
            status: RCLoggerStatus.SUCCESSED,
            resolution,
            fps
        }, {
    ...
    async __unsubscribe(tracks) {
        var _a;
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_UNSUBSCRIBE_T, {
        ...
        if (!validate('tracks', tracks, () => {
            ...
            logger$1.error(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_UNSUBSCRIBE_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> tracks'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_UNSUBSCRIBE_R, {
            status: RCLoggerStatus.SUCCESSED,
            trackIds: tracks.map(track => track.getTrackId()),
            roomId: this._roomId,
            userId: this._context.getCurrentId()
    ...
    onAudioLevelChange(handler, gap) {
        ...
        this._audioLevelReport = new RCAudioLevelReport(this);
        this._audioLevelReport.onAudioLevelChange(handler, gap || 1000);
        logger$1.info(RCLoggerTag.L_AUDIENCE_LIVING_ROOM_AUDIO_LEVEL_CHANGE_O, {
            status: RCLoggerStatus.SUCCESSED,
            handler: handler === null || handler === void 0 ? void 0 : handler.name,
            gap
        }, {
...
class RCMediaStreamCapture {
    ...
    async createMicrophoneAudioTrack(tag = 'RongCloudRTC', options) {
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_MICROPHONE_AUDIO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_MICROPHONE_AUDIO_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    async createCameraVideoTrack(tag = 'RongCloudRTC', options) {
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_CAMERA_VIDEO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        const resolution = isValidResolution(options === null || options === void 0 ? void 0 : options.resolution) ? options.resolution : RCResolution.W640_H480;
        const { width, height } = transResolution(resolution);
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_CAMERA_VIDEO_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    async createMicrophoneAndCameraTracks(tag = 'RongCloudRTC', options) {
        ...
        const tracks = [];
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_MICROPHONE_AND_CAMERA_TRACKS_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        const resolution = isValidResolution((_a = options === null || options === void 0 ? void 0 : options.video) === null || _a === void 0 ? void 0 : _a.resolution) ? options.video.resolution : RCResolution.W640_H480;
        const { width, height } = transResolution(resolution);
        const { stream, code } = await this._getMediaStream({
            video: {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_MICROPHONE_AND_CAMERA_TRACKS_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackIds: tracks.map(track => track.getTrackId())
        }, {
            logSource: LogSource.RTC
    ...
    async _createScreenTracks(tag, withAudio, loggerTag, options) {
        ...
        if (!ifSupportScreenShare()) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_SCREEN_VIDEO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
         ...
         * 传入时，类型为字符串
         */
        if (this._isElectron && !isUndefined(options === null || options === void 0 ? void 0 : options.chromeMediaSourceId) && !isString(options === null || options === void 0 ? void 0 : options.chromeMediaSourceId)) {
            logger$1.error(loggerTag, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        const resolution = isValidResolution(options === null || options === void 0 ? void 0 : options.resolution) ? options.resolution : RCResolution.W1280_H720;
        const { width, height } = transResolution(resolution);
    ...
    async createLocalAudioTrack(tag, track) {
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_AUDIO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_AUDIO_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackId: localAudioTrack.getTrackId()
        }, {
            logSource: LogSource.RTC
    ...
    async createLocalVideoTrack(tag, track) {
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_VIDEO_TRACK_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_VIDEO_TRACK_O, {
            status: RCLoggerStatus.SUCCESSED,
    ...
    async createLocalFileTracks(tag, file, options) {
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_FILE_TRACKS_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        return new Promise(resolve => {
            ...
            video.onloadedmetadata = () => {
                ...
                video.onerror = null;
                logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_FILE_TRACKS_O, {
                    status: RCLoggerStatus.SUCCESSED,
                    trackIds: tracks.map(track => track.getTrackId())
                }, {
                    logSource: LogSource.RTC
    ...
    async createLocalTracks(tag, stream, options) {
        const tracks = [];
        if (!isValidTag(tag)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_TRACKS_O, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.INVALID_TAGS,
                msg: 'invalid tag'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CREATE_LOCAL_TRACKS_O, {
            status: RCLoggerStatus.SUCCESSED,
            trackIds: tracks.map(track => track.getTrackId())
        }, {
            logSource: LogSource.RTC
...
class RCRTCClient extends RCMediaStreamCapture {
    ...
    naviDataChange(naviInfo) {
        logger$1.info(`on navi change data => ${JSON.stringify(naviInfo)}`);
    ...
    async joinRTCRoom(roomId, joinType, outerUserDatas, useMutilPeerC, roomType = RTCMode.RTC) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_JOIN_RTC_ROOM_T, {
            roomId,
            joinType,
            outerUserDatas,
            useMutilPeerC,
        ...
        if (this._crtRoom) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_JOIN_RTC_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.REPERT_JOIN_ROOM,
                msg: 'Join the room repeatedly'
            }, { logSource: LogSource.RTC });
    ...
    async joinCrossRTCRoom(roomId, joinType, outerUserDatas, useMutilPeerC, roomType = RTCMode.CROSS_MUTI) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_JOIN_CROSS_RTC_ROOM_T, {
            roomId,
            joinType,
            outerUserDatas,
            useMutilPeerC,
        ...
        if (this._crtRoom) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_JOIN_CROSS_RTC_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.REPERT_JOIN_ROOM,
                msg: 'Join the room repeatedly'
            }, { logSource: LogSource.RTC });
    ...
    async joinLivingRoom(roomId, livingType, joinType, outerUserDatas, useMutilPeerC) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_JOIN_LIVING_ROOM_T, {
            roomId,
            livingType,
            joinType,
            outerUserDatas,
    ...
    getAudienceClient(useMutilPeerC) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_GET_AUDIENCE_CLIENT_O, {
            status: RCLoggerStatus.SUCCESSED
        }, { logSource: LogSource.RTC });
    ...
    _onIMStatusChange(status) {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_CONNECTION_STATE_S, {
            status: RCLoggerStatus.SUCCESSED,
            data: status
        }, {
            logSource: LogSource.RTC
    ...
    _onIMDisconnect() {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_DISCONNECT_S, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    _onIMUninit() {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_DESTROY_S, {
            status: RCLoggerStatus.SUCCESSED
        }, {
            logSource: LogSource.RTC
        });
    ...
    async leaveRoom(room) {
        var _a, _b;
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_LEAVE_ROOM_T, {
            userId: this._context.getCurrentId(),
        ...
        if (!this._crtRoom) {
            logger$1.warn(RCLoggerTag.L_RTC_CLIENT_LEAVE_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
        ...
        this._service.detectorMediaSever();
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_LEAVE_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            userId: this._context.getCurrentId(),
    ...
    async joinLivingRoomAsAudience(roomId, livingType, useMutilPeerC) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_JOIN_LIVING_ROOM_AS_AUDIENCE_T, {
            roomId,
            livingType,
            useMutilPeerC
        }, {
        ...
        if (code !== ErrorCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_JOIN_LIVING_ROOM_AS_AUDIENCE_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.SIGNAL_AUDIENCE_JOIN_ROOM_FAILED,
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_JOIN_LIVING_ROOM_AS_AUDIENCE_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomData: data
        }, {
            logSource: LogSource.RTC
    ...
    async leaveLivingRoomAsAudience(room) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_LEAVE_LIVING_ROOM_AS_AUDIENCE_T, {
        ...
        if (!this._crtAudienceLivingRoom) {
            logger$1.warn(RCLoggerTag.L_RTC_CLIENT_LEAVE_LIVING_ROOM_AS_AUDIENCE_R, {
                status: RCLoggerStatus.FAILED,
                code: '',
                msg: 'Room does not exist, whiout leave'
            }, {
        ...
        if (this._crtAudienceLivingRoom !== room) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_LEAVE_LIVING_ROOM_AS_AUDIENCE_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        this._crtAudienceLivingRoom = null;
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_LEAVE_LIVING_ROOM_AS_AUDIENCE_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomId: room.getRoomId(),
            userId: this._context.getCurrentId()
        }, {
    ...
    async upgradeToAnchorRoom(room) {
        if (!validate('room', room, () => room instanceof RCAudienceLivingRoom, true)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_UPGRADE_TO_ANCHOR_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
                msg: 'params error -> room'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_UPGRADE_TO_ANCHOR_ROOM_T, {
            roomId: room.getRoomId(),
            userId: this._context.getCurrentId()
        }, {
            logSource: LogSource.RTC
        ...
        // 重置观众房间
        this._crtAudienceLivingRoom = null;
        return { room: crtRoom, code: RCRTCCode.SUCCESS, userIds: crtRoom.getRemoteUserIds(), tracks: crtRoom.getRemoteTracks() };
    }
    /**
     * 降级为观众房间
     * @param room 主播房间实例
    ...
    async downgradeToAudienceRoom(room) {
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_DOWNGRADE_TO_AUDIENCE_ROOM_T, {
            roomId: room._roomId,
            userId: this._context.getCurrentId()
        }, {
            logSource: LogSource.RTC
        ...
        if (!room.isMainRoom()) {
            ...
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_DOWNGRADE_TO_AUDIENCE_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.THE_FUNCTION_IS_DISABLED_IN_PKROOM,
                msg: 'method not available in room'
            }, {
        ...
        if (!validate('room._roomId', room._roomId, notEmptyString, true)) {
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_DOWNGRADE_TO_AUDIENCE_ROOM_R, {
                status: RCLoggerStatus.FAILED,
                code: RCRTCCode.PARAMS_ERROR,
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_DOWNGRADE_TO_AUDIENCE_ROOM_R, {
            status: RCLoggerStatus.SUCCESSED,
            roomData: data
        }, {
            logSource: LogSource.RTC
    ...
    async getJoinedRoomInfo() {
        ...
        if (code !== ErrorCode.SUCCESS) {
            ...
            logger$1.error(RCLoggerTag.L_RTC_CLIENT_GET_JOINED_ROOM_INFO_O, {
                status: RCLoggerStatus.FAILED,
                code,
                msg: 'Switch identity error'
            }, {
        ...
        logger$1.info(RCLoggerTag.L_RTC_CLIENT_GET_JOINED_ROOM_INFO_O, {
            status: RCLoggerStatus.SUCCESSED,
            roomInfo: data
        }, {
            logSource: LogSource.RTC
...
const installer = {
    ...
    verify(runtime) {
        ...
        VersionManage.add('plugin-rtc', "5.5.1-alpha.1");
        if (!VersionManage.validEngine("^5.5.1-alpha.1")) {
            logger.error(`The current engine version '${VersionManage.getInfo().engine}' error, plugin-rtc required engine version at least '${"^5.5.1-alpha.1"}'.`);
            return false;
        }
        return true;
    },
    setup(context, runtime, options = {}) {
        ...
        assert('options.mediaServer', options.mediaServer, (value) => {
            // 非有效 http URL 地址或页面为 https 协议而 value 为 http 协议时无效
            // 其他情况均不检测，以便于 Electron 下自定义协议能够通过检测
            return !(!isHttpUrl(value) || (location.protocol === 'https:' && !/^https/.test(value)));
        });
        assert('options.timeout', options.timeout, (value) => {
            return isNumber(value) && value >= 5000 && value <= 30000;
        });
        assert('options.pingGap', options.pingGap, (value) => {
            return isNumber(value) && value >= 3000 && value <= 10000;
        });
...
export { BackgroundPictureFillMode, MixLayoutMode, MixVideoRenderMode, RCAbstractRoom, RCAudienceClient, RCAudienceLivingRoom, RCAudioBitrate, RCCameraVideoTrack, RCFrameRate, RCInnerCDNPullIsHttps, RCInnerCDNPullKind, RCKickReason, RCLivingRoom, RCLivingType, RCLocalAudioTrack, RCLocalFileAudioTrack, RCLocalFileTrack, RCLocalFileVideoTrack, RCLocalTrack, RCLocalVideoTrack, RCMCUConfigBuilder, RCMediaStreamCapture, RCMediaType, RCMicphoneAudioTrack, RCRTCClient, RCRTCCode, RCRTCLiveRole, RCRTCPingResult, RCRTCRoom, RCRemoteAudioTrack, RCRemoteTrack, RCRemoteVideoTrack, RCResolution, RCScreenAudioTrack, RCScreenVideoTrack, RCTag, RCTrack, RCVideoBitrate, RTCJoinType, device, helper, installer };
